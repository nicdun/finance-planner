...
export function EditBudgetDialog({
  ...
  const onSubmit = async (data: EditBudgetFormData) => {
    try {
      ...
      alert("Fehler beim Aktualisieren des Budgets");
    } finally {
      setLoading(false);
    }
  };
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Aktualisieren Sie Ihr Budget. Die tatsächlichen Ausgaben werden
            automatisch aus Ihren Transaktionen berechnet.
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="mt-2 text-xs text-gray-600">
                    💡 Die aktuellen Ausgaben für diese Kategorie werden
                    automatisch aus Ihren Transaktionen berechnet.
                  </div>
                </div>
              </motion.div>
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={loading}>
                {loading ? "Speichern..." : "Budget aktualisieren"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
